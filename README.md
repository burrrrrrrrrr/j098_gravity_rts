...
- `packages/client` - Contains the game.
- `packages/client/src/main.ts` - The main entry point for the client. This contains the game which starts the game.
...
- `packages/server/server.ts` - Initiates WebSocket server for Colyseus.
